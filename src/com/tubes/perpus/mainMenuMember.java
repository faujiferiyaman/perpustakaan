...
public class mainMenuMember extends javax.swing.JFrame {
     ...
     */
    public mainMenuMember(Integer... memberId) {
        initComponents();
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (member.isVisible())
            ...
            formBorrow fBr = new formBorrow(memberId);
...
//------------------------------------LOAD TABLE------------------------------
    private void loadPublisherTable() {
        ...
        try {
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()) {
                model.addRow(new Object[]{res.getString("name"), res.getString("address"), res.getString("phone")});
            }
            tablePublisher.setModel(model);
        } catch (SQLException e) {
        }
    ...
    private void loadEmployeeTable() {
        ...
        try {
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()) {
                model.addRow(new Object[]{res.getString("e.name"), res.getString("u.email"), res.getString("e.phone"), res.getString("e.address")});
            }
            tableEmployee.setModel(model);
        } catch (SQLException e) {
        }
    ...
    private void loadCategoryTable() {
        ...
        try {
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()) {
                model.addRow(new Object[]{res.getString("name")});
            }
    ...
    private void loadBookTable() {
        ...
        try {
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()) {
                model.addRow(new Object[]{res.getString("b.title"), res.getString("p.name"), res.getString("b.author"), res.getString("b.year"), res.getString("c.name"), res.getString("b.qty")});
            }
            tableBook.setModel(model);
        } catch (SQLException e) {
        }
    ...
    private void loadMemberTable() {
        ...
        try {
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            while (res.next()) {
                model.addRow(new Object[]{res.getString("m.name"), res.getString("u.email"), res.getString("m.phone"), res.getString("m.address")});
            }
            tableMember.setModel(model);
        } catch (Exception e) {
        }
