...
public class login extends javax.swing.JFrame {
    ...
    public mainMenuEmployee mme = null;
    public mainMenuMember mmm = null;
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        try {
            String sql = "SELECT * FROM users WHERE email = '" + txtusername.getText() + "' AND password = '" + password + "'";
            java.sql.Connection conn = (Connection) connection.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
            if (res.next()) {
                userId = res.getInt("id");
                if ("employee".equals(res.getString("role")) || "admin".equals(res.getString("role"))) {
                    getEmployee();
                } else {
                    getMember();
                }
    ...
    public static String md5Java(String message) {
        ...
        try {
            ...
            Logger.getLogger(mainMenuEmployee.class.getName()).log(Level.SEVERE, null, ex);
        }
        return digest;
    }
...
//-------------View Login Account----------------------------
    ...
    public void getEmployee() {
        try {
            ...
            String sql = "SELECT * FROM employees WHERE user_id='" + userId + "'";
            java.sql.Connection conn = (Connection) connection.configDB();
            java.sql.Statement stm = conn.createStatement();
            java.sql.ResultSet res = stm.executeQuery(sql);
            if (res.next()) {
                employeeId = res.getInt("id");
                employeeName = res.getString("name");
            } else {
                System.out.println("Gagal Login");
            }

            mme = new mainMenuEmployee();
            mme.employeeId = employeeId;
            mme.employeeName = employeeName;
            mme.viewData();
            mme.setVisible(true);
    ...
    public void getMember() {
        try {
            ...
            java.sql.ResultSet res = stm.executeQuery(sql);
            if (res.next()) {
                memberId = res.getInt("id");
                memberName = res.getString("name");
            } else {
                System.out.println("Gagal Login");
            }

            mmm = new mainMenuMember(memberId);
            mmm.memberName = memberName;
            mmm.viewData();
            mmm.setVisible(true);
