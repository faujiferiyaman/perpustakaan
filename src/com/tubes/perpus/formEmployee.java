...
public class formEmployee extends javax.swing.JFrame {
        ...
        if (String.valueOf(txtPassword.getPassword()).equals(String.valueOf(txtPasswordConfirm.getPassword()))) {
            try {
                ...
                String sql = "INSERT INTO users (email, password, role) "
                        + "VALUES('" + txtEmail.getText() + "','" + pass + "','" + "employee" + "')";
                ...
                sql = "INSERT INTO employees (name, address, phone, user_id) "
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        try {
            String sql = "UPDATE employees SET name='" + txtName.getText() + "',address='" + txtAddress.getText() + "',phone='" + txtPhone.getText() + "'WHERE id='" + employeeId + "'";
            java.sql.Connection conn = (Connection) connection.configDB();
            java.sql.PreparedStatement pst = conn.prepareStatement(sql);
            pst.execute();
            JOptionPane.showMessageDialog(null, "Penyimpanan Data Berhasil");
